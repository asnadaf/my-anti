...
const ProductsContent: React.FC<ProductsContentProps> = ({ category = 'all' }) => {
      ...
      <section className="container mx-auto px-4 py-12" aria-label="Products List">
        ...
        {filteredProducts.length === 0 && (
          <div className="text-center py-16" role="status">
            <h3 className="text-2xl font-semibold mb-2 text-gray-900 dark:text-foreground">No products found</h3>
            <p className="text-gray-600 dark:text-muted-foreground">Try adjusting your search or filter criteria.</p>
          </div>
        )}
