      ...
      <div className="container mx-auto px-4 py-12">
        <Tabs defaultValue="help" className="w-full">
          ...
          <TabsContent value="help" className="mt-0">
            <div className="mb-8">
              <h2 className="text-2xl font-semibold mb-6 text-gray-900 dark:text-foreground">Frequently Asked Questions</h2>
              <Accordion type="single" collapsible className="w-full">
                {supportFaqs.map((faq, index) => (
                  <AccordionItem key={index} value={`item-${index}`} className="border-gray-200 dark:border-border">
                    <AccordionTrigger className="text-left font-medium text-gray-900 dark:text-foreground">
                      {faq.question}
                    </AccordionTrigger>
              ...
              <div className="mt-8 bg-blue-50 dark:bg-gray-800 p-6 rounded-lg">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-foreground">Still Need Help?</h3>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-600 dark:text-muted-foreground">+1 (888) 123-4567</span>
                  </div>
                  <div className="flex items-center">
                    <Mail className="h-5 w-5 text-blue-600 dark:text-blue-400 mr-2" />
                    <span className="text-gray-600 dark:text-muted-foreground">support@keyguardian.com</span>
                  </div>
                  <div className="flex items-center">
                    <Clock className="h-5 w-5 text-blue-600 dark:text-blue-400 mr-2" />
                    <span className="text-gray-600 dark:text-muted-foreground">24/7 Support</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <TabsContent value="installation" className="mt-0">
            <h2 className="text-2xl font-semibold mb-6 text-gray-900 dark:text-foreground">Installation Guides</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {installationGuides.map((guide, index) => (
                <Card key={index} className="border border-gray-200 dark:border-border">
                  <CardHeader>
                    <CardTitle className="text-gray-900 dark:text-foreground">{guide.title}</CardTitle>
                    <CardDescription>Step-by-step installation instructions</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-muted-foreground">
          ...
          <TabsContent value="contact" className="mt-0">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                <h2 className="text-2xl font-semibold mb-6 text-gray-900 dark:text-foreground">Get In Touch</h2>
                ...
                <form className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="name" className="block text-sm font-medium text-gray-700 dark:text-muted-foreground mb-2">
                        Name
                      </label>
                      <input
                        type="text"
                        id="name"
                        className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-border bg-white dark:bg-card text-gray-900 dark:text-foreground focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="Your name"
                      />
                    </div>
                    <div>
                      <label htmlFor="email" className="block text-sm font-medium text-gray-700 dark:text-muted-foreground mb-2">
                        Email
                      </label>
                      <input
                        type="email"
                  ...
                  <div>
                    <label htmlFor="subject" className="block text-sm font-medium text-gray-700 dark:text-muted-foreground mb-2">
                      Subject
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="message" className="block text-sm font-medium text-gray-700 dark:text-muted-foreground mb-2">
                      Message
                    </label>
                    <textarea
                      id="message"
              ...
              <div className="bg-blue-50 dark:bg-gray-800 p-8 rounded-lg">
                <h3 className="text-xl font-semibold mb-6 text-gray-900 dark:text-foreground">Other Ways to Reach Us</h3>
                <div className="space-y-6">
                  <div className="flex items-start">
                    <Phone className="h-6 w-6 text-blue-600 dark:text-blue-400 mr-4 mt-1" />
                    <div>
                      <h4 className="font-medium text-gray-900 dark:text-foreground">Phone Support</h4>
                      <p className="text-gray-600 dark:text-muted-foreground">+1 (888) 123-4567</p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-gray-900 dark:text-foreground">Email Support</h4>
                      <p className="text-gray-600 dark:text-muted-foreground">support@keyguardian.com</p>
                      <p className="text-sm text-gray-500 dark:text-gray-400">Response within 24 hours</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <MessageCircle className="h-6 w-6 text-blue-600 dark:text-blue-400 mr-4 mt-1" />
                    <div>
                      <h4 className="font-medium text-gray-900 dark:text-foreground">Live Chat</h4>
                      <p className="text-gray-600 dark:text-muted-foreground">Available during business hours</p>
                      <p className="text-sm text-gray-500 dark:text-gray-400">9:00 AM - 5:00 PM EST</p>
                    </div>
                  </div>
                </div>
              </div>
